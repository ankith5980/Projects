...
var gBegin=[1940,1,1];	// static calendar range begin from [Year,Month,Date]
...
var gcCalBG="#3063A2";	// the background color of the outer calendar panel.
...
var gsBottom="<input class=today type=button value='Clear' onclick='gdCtrl.value=\"\";fHideCal();return false;'> <input class=today type=button value='Today' onclick='if(!NN4)this.blur();if(!fSetDate(gToday[0],gToday[1],gToday[2]))alert(\"You may not pick this day!\");return false;'>";	// the content of the bottom section.
...
var gcCellBG="#F4F4F4";	// default background color of the cells. Use "" for transparent!!!
...
var gcWorkday="#3063A2";	// Workday font color
var gcSat="#3063A2";	// Saturday font color
var gcSatBG="#F4F4F4";	// Saturday background color
var gcSun="#3063A2";	// Sunday font color
var gcSunBG="#F4F4F4";	// Sunday background color
